...
export default async function BalloonCard({infos}){
    ...
    return(
        <Link href={`/balloon/${id}`} className="flex-none mx-3 relative w-36 h-36 lg:w-48 lg:h-48 neo_shadow rounded-xl overflow-hidden">
            ...
            <article className=" flex flex-col items-center justify-end z-30 absolute bottom-0 h-fit  left-0 w-full bg-gradient-to-t from-[#000000b7] to-[#00000077] rounded-xl text-center  ">
                <h3 className="text-yellow-100 shadow-xl text-base text-wrap font-thin">
                    {name}
                </h3>

                <h2 className="text-base text-yellow-100 self-center">
